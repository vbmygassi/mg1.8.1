...
class Mage_Adminhtml_Block_Catalog_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getModel('catalog/product')->getCollection()
            ...
            ->addAttributeToSelect("old_price")
            ->addAttributeToSelect("is_top_product")
            ->addAttributeToSelect("is_stream_product");
...
/*
		$collection->joinAttribute(
			'is_top_product',
			'catalog_product/is_top_product',
			'entity_id',
			 null,
			'inner',
			$store->getId()
		...
		$collection->joinAttribute(
			'is_stream_product',
			'catalog_product/is_stream_product',
			'entity_id',
			 null,
			'inner',
			$store->getId()
...
*/
	...
	// Streichpreis
        ...
        $this->addColumn('top_product',
		array(
			'header'=> Mage::helper("catalog")->__("Top Product"),
			'width' => '70px',
			"type" => "yesorno",
			'index' => 'is_top_product'
		)
	);

        $this->addColumn('stream_product',
		array(
			'header'=> Mage::helper("catalog")->__("Stream Product"),
			'width' => '70px',
			"type" => "yesorno",
